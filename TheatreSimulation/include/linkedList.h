...
* If not already defined, define BOOL_H. Typedef 'bool' as a true or false int*/
...
/*Define the struct; patronStruct which includes;
* A char * named id. A bool named movie. A bool named snack. An int named time*/
...
struct patronStruct 
{
  ...
  int time;
  int waitTime;
  struct patronStruct * next;
};

/*Define the word 'Patron' as 'struct patronStruct'*/

typedef struct patronStruct Patron;
